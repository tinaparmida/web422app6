...
const Home = () => {
  return (
    <div>
      <Row>
        <Col md={12}>
        <Image src="https://upload.wikimedia.org/wikipedia/commons/3/30/Metropolitan_Museum_of_Art_%28The_Met%29_-_Central_Park%2C_NYC.jpg" fluid rounded alt="Metropolitan Museum of Art" style={{ marginBottom: '20px' }} />
        ...
        <Col md={6}>
          ...
          <p>
            For more information, you can visit the Wikipedia entry for the <a href="https://en.wikipedia.org/wiki/Metropolitan_Museum_of_Art" target="_blank" rel="noreferrer">Metropolitan Museum of Art</a>.
          </p>
        </Col>
      </Row>
    </div>
